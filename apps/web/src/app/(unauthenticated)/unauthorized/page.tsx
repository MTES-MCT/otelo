...
export default async function Unauthorized() {
  ...
  return (
    <div className="fr-container fr-py-20v">
      <div className="fr-grid-row fr-grid-row--center">
        <div className="fr-col-12 fr-col-md-8 fr-col-lg-6">
          <div className="fr-text--center">
            ...
            <h1 className="fr-mb-4v">Accès non autorisé</h1>
            ...
            <UnauthorizedActions />
            <p className="fr-text--xs fr-text--alt">Vous serez redirigé vers le formulaire de demande d'accès.</p>
          </div>
        </div>
      </div>
    </div>

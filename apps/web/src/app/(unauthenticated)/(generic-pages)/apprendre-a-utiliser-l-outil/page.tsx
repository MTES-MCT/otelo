    ...
    <>
      ...
      <div className="fr-pb-4w">
        ...
        vous pouvez accéder à l'application sous mandat d'une collectivité ou territoire le temps de votre étude."
          imageUrl="/assets/centre-d-aide/otelo-creer-son-compte-otelo.jpg"
      ...
      <div className="fr-pb-4w">
        ...
        analyse adaptée à vos besoins."
          imageUrl="/assets/centre-d-aide/otelo-debuter-l-elaboration-d-un-scenario.jpg"
      ...
      <div className="fr-pb-4w">
        ...
        clés (démographie, vacance, résidences secondaires, dynamique du parc) pour obtenir une première estimation complète."
          imageUrl="/assets/centre-d-aide/otelo-elaborer-un-scenario-de-a-a-z.jpg"
      ...
      <div className="fr-pb-4w">
        ...
        le bassin d'habitat."
          imageUrl="/assets/centre-d-aide/otelo-creer-un-territoire-a-facon.jpg"
      ...
      <div className="fr-pb-4w">
        ...
        (décohabitation), afin d'obtenir des estimations de besoins en logements cohérentes avec votre territoire et ses dynamiques."
          imageUrl="/assets/centre-d-aide/otelo-parametrer-les-projections-demographiques.jpg"
      ...
      <div className="fr-pb-4w">
        ...
        territoire."
          imageUrl="/assets/centre-d-aide/otelo-importer-des-donnees-a-facon.jpg"
      ...
      <div className="fr-pb-4w">
        ...
        et d'intégrer le potentiel existant de votre territoire."
          imageUrl="/assets/centre-d-aide/otelo-cibler-la-vacance-de-longue-duree.jpg"
      ...
      <div className="fr-pb-4w">
        ...
        spécificités d'usage de votre territoire."
          imageUrl="/assets/centre-d-aide/otelo-cibler-le-taux-de-residences-secondaires.jpg"
      ...
      <div className="fr-pb-4w">
        ...
        de besoins en logements et refléter les transformations du parc existant."
          imageUrl="/assets/centre-d-aide/otelo-parametrer-les-dynamiques-de-renouvellement-urbain.jpg"
      ...
      <div className="fr-pb-4w">
        ...
        inadéquation financière, sur-occupation, insalubrité) pour élaborer des politiques de l'habitat responsables et adaptées."
          imageUrl="/assets/centre-d-aide/otelo-resorber-le-mal-logement.jpg"
      ...
      <div className="fr-pb-4w">
        ...
        élus, groupes de travail ou prises de décision."
          imageUrl="/assets/centre-d-aide/otelo-generer-une-presentation-ppt-editable.jpg"

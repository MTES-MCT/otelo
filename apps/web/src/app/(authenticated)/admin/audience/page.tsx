...
export default function AudiencePage() {
  ...
  return (
    <>
      ...
      {error && <Alert className={fr.cx('fr-mb-3w')} description="Erreur lors du chargement des données" severity="error" small />}
      ...
      <h2 className={fr.cx('fr-h5')}>Connexions</h2>
      ...
      <div className={`${styles.grid2} ${fr.cx('fr-mb-3w')}`}>
        <ChartCard
      ...
      <h2 className={fr.cx('fr-h5', 'fr-mt-4w')}>Activation & rétention</h2>
      ...
      <h2 className={fr.cx('fr-h5', 'fr-mt-4w')}>Mesuré via Matomo</h2>
      <div className={styles.card}>
        <div className={fr.cx('fr-p-3w')}>
          <p className={fr.cx('fr-text--sm')}>
          ...
          <div className="fr-flex fr-flex-gap-2v" style={{ flexWrap: 'wrap' }}>
